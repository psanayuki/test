...
class B_LayerNorm(nn.Module):
    def __init__(self, hidden_size, eps=1e-12):
        """Construct a layernorm module in the TF style (epsilon inside the square root).
        """
        super(B_LayerNorm, self).__init__()
...
class B_SublayerConnection(nn.Module):
    """
    ...
    def __init__(self, hidden_size, dropout):
        super(B_SublayerConnection, self).__init__()
        self.norm = B_LayerNorm(hidden_size)
...
class B_PositionwiseFeedForward(nn.Module):
    "Implements FFN equation."

    def __init__(self, hidden_size, dropout=0.1):
        super(B_PositionwiseFeedForward, self).__init__()
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, B_LayerNorm):
...
class B_MultiHeadedAttention(nn.Module):
...
class B_TransformerBlock(nn.Module):
    def __init__(self, hidden_size, attn_heads, dropout):
        super(B_TransformerBlock, self).__init__()
        self.attention = B_MultiHeadedAttention(heads=attn_heads, hidden_size=hidden_size, dropout=dropout)
        self.feed_forward = B_PositionwiseFeedForward(hidden_size=hidden_size, dropout=dropout)
        self.input_sublayer = B_SublayerConnection(hidden_size=hidden_size, dropout=dropout)
        self.output_sublayer = B_SublayerConnection(hidden_size=hidden_size, dropout=dropout)
        self.dropout = nn.Dropout(p=dropout)
...
class B_Transformer_rep(nn.Module):
    def __init__(self, args):
        super(B_Transformer_rep, self).__init__()
        self.hidden_size = args.hidden_size
        self.heads = args.n_heads # 4
        self.dropout = args.dropout
        self.n_blocks = args.n_layers # args.num_blocks
        self.transformer_blocks = nn.ModuleList(
            [B_TransformerBlock(self.hidden_size, self.heads, self.dropout) for _ in range(self.n_blocks)])
